	...
	self.xmlHttpReq.onreadystatechange = function() {
		if (self.xmlHttpReq.readyState == 4) {
			if (self.xmlHttpReq.responseText==1) {
				document.getElementById("updateDiv"+value).innerHTML="<font color='green'>Salvo</font>";
			} else {
				document.getElementById("updateDiv"+value).innerHTML="<font color='red'>Falha</font>";
			}
		}
	}
