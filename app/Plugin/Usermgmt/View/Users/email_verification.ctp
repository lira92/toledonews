	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				<span class="umstyle1"><?php echo __('Verificação de email'); ?></span>
			...
			<div class="um_box_mid_content_mid" id="forgot">
				...
				<div>
					<div class="umstyle3"><?php echo __('Digite o e-mail/usuário');?></div>
					<div class="umstyle4" ><?php echo $this->Form->input("email" ,array('label' => false,'div' => false,'class'=>"umstyle5" ))?></div>
					<div style="clear:both"></div>
				</div>
				<div>
					<div class="umstyle3"></div>
					<div class="umstyle4"><?php echo $this->Form->Submit(__('Enviar E-mail'));?></div>
					<div style="clear:both"></div>
				</div>
